...
<body>
    ...
    <div class="absolute2">
        ...
        <div class="container-1">
            ...
            <asp:Button ID="Button1" runat="server" Text="Search by Profession" Width="180px" />
        </div>
        <div class="container-1">
            &nbsp;<div class="container">
                <asp:Button ID="Button2" runat="server" Text="Search by Country" Width="180px" />
            </div>
        </div>
        <div class="container-1">
            <span class="icon"><i class="fa fa-search"></i></span>
            <input type="search" id="search" placeholder="Search Job by Company..." />
            <div class="container">
